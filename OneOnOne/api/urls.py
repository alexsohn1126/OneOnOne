...
from .views.calendar_views import CalendarList, CalendarDetail, CreateInvitee, TimeslotUpdateDestroy
...
urlpatterns = [
    ...
    path('accounts/delete/<int:pk>/', DeleteProfile.as_view(), name="profiledelete"),
